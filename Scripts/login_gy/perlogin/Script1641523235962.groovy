...
WebUI.delay(10)
//用户名
WebUI.setText(new TestObject().addProperty("id", ConditionType.EQUALS, "userName"), GlobalVariable.perloginname)
WebUI.setText(new TestObject().addProperty("id", ConditionType.EQUALS, "password"), GlobalVariable.loginpwd)
