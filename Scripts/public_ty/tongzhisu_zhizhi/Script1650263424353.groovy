...
CustomKeywords.'upfile.pickFile'(new TestObject().addProperty('xpath', ConditionType.EQUALS, '//*[@id="pane-listed"]/div/div/div/div/div/div/div[2]'), 'D:\\测试数据\\2、承诺函.pdf')
WebUI.delay(5)
'意向资格确认'
WebUI.click(new TestObject().addProperty('id', ConditionType.EQUALS, 'tab-intention'))
WebUI.delay(5)
'上传意向资格确认文件'
CustomKeywords.'upfile.pickFile'(new TestObject().addProperty('xpath', ConditionType.EQUALS, '//*[@id="pane-intention"]/div/div/div/div/div/div/div[2]'), 'D:\\测试数据\\摩托车-报告.pdf')
