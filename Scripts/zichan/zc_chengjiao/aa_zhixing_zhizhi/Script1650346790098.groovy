...
WebUI.callTestCase(findTestCase('zichan/zc_zhuanyong/web_zcbming'), [:], FailureHandling.STOP_ON_FAILURE)
...
'纸质挂牌通知书三级审核'
WebUI.callTestCase(findTestCase('public_ty/tongzhishu/tongzhisu_zhizhi_zc'), [:], FailureHandling.STOP_ON_FAILURE)
